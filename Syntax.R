...
# Arrays are in many ways similar to matrixes, as they similarly are limited to a single data type. 
# However, they may have 1 - n dimensions

vecn <- rnorm(80)

ar1 <- array(vecn, dim = c(80, 1))
ar1[1:10, ]

ar2 <- array(vecn, dim = c(2, 40))
ar2[1:2, 1:10]

ar3 <- array(vecn, dim = c(4,4,5))
ar3[1:2, 2, 1:3]
